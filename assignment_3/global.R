...
glmnet_initial <- c("impute_bag", "dow", "center", "scale", "dummy", "interact") 
pls_initial <- c("corr", "dow", "center", "scale", "naomit", "dummy", "interact")   
rpart_initial <- c("corr","month", "center", "scale", "impute_knn", "YeoJohnson", "pls", "interact") 

# maintenance point ---------------------------------------------------------------------------------------------------------------------------
# add further preprocessing choices for the new methods here

pcr_initial <- c("corr", "center", "scale", "naomit", "dow", "dummy", "interact") 
lmStepAIC_initial <- c("corr", "dow", "center", "scale", "naomit", "dummy", "interact") 

bstTree_initial <- c("dow", "impute_knn", "corr") 
rf_initial <- c("dow", "impute_knn", "corr") 

monmlp_initial <- c("corr", "dow", "center", "scale", "naomit", "dummy") 
mlpML_initial <- c("corr", "dow", "center", "scale", "impute_knn", "dummy", "YeoJohnson") 

svmRadialCost_initial <- c("center", "scale", "dow", "impute_knn", "dummy")   
gaussprRadial_initial <- c("corr", "center", "scale", "naomit", "dow", "dummy")
svmLinear_initial <- c("corr", "center", "scale", "dow", "impute_knn", "dummy", "pls", "interact")  
gaussprLinear_initial <- c("corr", "dow", "center", "scale", "naomit", "dummy", "pls", "interact")
